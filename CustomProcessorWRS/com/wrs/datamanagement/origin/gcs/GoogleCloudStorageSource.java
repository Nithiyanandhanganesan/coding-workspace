...
public class GoogleCloudStorageSource extends BaseSource {
  ...
  protected List<ConfigIssue> init() {
    ...
    errorBlobHandler = new GcsObjectPostProcessingHandler(getContext(), storage, gcsOriginConfig.gcsOriginErrorConfig);
  ...
  public String produce(String lastSourceOffset, int maxBatchSize, BatchMaker batchMaker) throws StageException {
    ...
    if (minMaxPriorityQueue.isEmpty() && fileOffset.equals(END_FILE_OFFSET)) {
    ...
    try {
      ...
      while (recordCount < maxBatchSize) {
        try {
          ...
          LOG.info(String.valueOf(recordCount));
